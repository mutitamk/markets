...
<?php
   $Date = date("Y-m-d");
$x=1;
$sql = "SELECT * FROM zone_chanel LEFT JOIN system_chanels ON zone_chanel.lock_id = system_chanels.id_lock WHERE zone='b'";
                ...
                <div class="card-body">
                 <div class="row">
                  ...
                  <p class="mt-3 mb-0 text-muted text-sm">
                    <span class="text-success mr-2">รายเดือน : ฿700</span>
                    <span class="text-info">รายวัน : ฿200</span>
                  </p>
                </div>
              </div>
            </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select class="select custom-select" name="price" id="onlytxt" required>
                            <option value="">-- เลือกปรเภท --</option>
                            <option value="700">รายเดือน 700 ฿</option>
                            <option value="200">รายวัน 200 ฿</option>
                          </select>
                        </div>
                      </div>
