...
<?php
   $Date = date("Y-m-d");
$x=1;
$sql = "SELECT * FROM zone_chanel LEFT JOIN system_chanels ON zone_chanel.lock_id = system_chanels.id_lock WHERE zone='a'";
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select class="select custom-select" name="price" id="onlytxt" required>
                            <option value="">-- เลือกปรเภท --</option>
                            <option value="620" required>รายเดือน 620 ฿</option>
